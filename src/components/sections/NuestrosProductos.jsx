                ...
                <Col lg="4" className="my-3">
                    <Card className="bg-brand-dribbble text-white text-center">
                        <CardBody>
                            ...
                            <FontAwesomeIcon icon={faHorseHead} size="4x" className="mt-3" />
                        </CardBody>
                    </Card>
                </Col>
                <Col lg="4" className="my-3">
                    <Card className="bg-first text-white text-center">
                        <CardBody>
                            ...
                            <FontAwesomeIcon icon={faSyringe} size="4x" className="mt-3" />
                        </CardBody>
                    </Card>
                </Col>
                <Col lg="4" className="my-3">
                    <Card className="bg-danger text-white text-center">
                        <CardBody>
                            ...
                            <FontAwesomeIcon icon={faBolt} size="4x" className="mt-3" />
                            <h5 className="h5 mt-4">
                                Alambres, Cables electroplásticos, Energizadores.
                            </h5>
                        </CardBody>
                    </Card>
                </Col>
                <Col lg="4" className="my-3">
                    <Card className="bg-info text-white text-center">
                        <CardBody>
                            ...
                            <FontAwesomeIcon icon={faVial} size="4x" className="mt-3" />
                            <h5 className="h5 mt-4">
                                Herbicidas, Insecticidas, Fertilizantes, Curasemillas e Inoculantes
                                Fungicidas.
                            </h5>
                        </CardBody>
                    </Card>
                ...
                <Col lg="4" className="my-3">
                    <Card className="bg-success text-white text-center">
                        <CardBody>
                            ...
                            <FontAwesomeIcon icon={faSeedling} size="4x" className="mt-3" />
                            <br />
                            <a
                ...
                <Col lg="4" className="my-3">
                    <Card className="bg-warning text-white text-center">
                        <CardBody>
                            ...
                            <FontAwesomeIcon icon={faTractor} size="4x" className="mt-3" />
                            <h5 className="h5 mt-4">Guantes, Aplicadores de caravanas.</h5>
                        </CardBody>
                    </Card>
                </Col>
            </Row>
